        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <pre className="font-mono text-xs text-white leading-none hidden sm:block">
{`┌─┐
│●│
└─┘`}
              </pre>
              <span className="font-mono text-lg font-bold tracking-tighter">
                PRECISION<span className="text-neutral-500">BOM</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/register"
                className="font-mono text-sm px-4 py-2 bg-white text-black border-2 border-white hover:bg-black hover:text-white transition-colors uppercase tracking-wider font-bold"
              >
                SIGN UP
              </Link>
            </div>
      ...
      {/* Footer - Brutalist */}
      <footer className="relative z-10 border-t-4 border-white bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* ASCII Divider */}
          <pre className="font-mono text-neutral-700 text-xs text-center mb-8">
{`════════════════════════════════════════════════════════════════════════════════`}
          </pre>
          ...
          {/* ASCII Footer */}
          <pre className="font-mono text-neutral-800 text-xs text-center mt-8">
{`●────────────────────────────────●────────────────────────────────●`}
          </pre>
        </div>
      </footer>
